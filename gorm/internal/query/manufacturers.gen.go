...
func newManufacturer(db *gorm.DB, opts ...gen.DOOption) manufacturer {
	...
	_manufacturer.manufacturerDo.UseModel(&models.Manufacturer{})
	...
	_manufacturer.Vehicles = manufacturerHasManyVehicles{
		...
		RelationField: field.NewRelation("Vehicles", "models.Model"),
		Manufacturer: struct {
			field.RelationField
			Vehicles struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Vehicles.Manufacturer", "models.Manufacturer"),
			Vehicles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Vehicles.Manufacturer.Vehicles", "models.Model"),
			},
		},
		Parts: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("Vehicles.Parts", "models.Part"),
			Models: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Vehicles.Parts.Models", "models.Model"),
			},
		},
	}
...
func (a manufacturerHasManyVehicles) Model(m *models.Manufacturer) *manufacturerHasManyVehiclesTx {
...
func (a manufacturerHasManyVehiclesTx) Find() (result []*models.Model, err error) {
	return result, a.tx.Find(&result)
}

func (a manufacturerHasManyVehiclesTx) Append(values ...*models.Model) (err error) {
...
func (a manufacturerHasManyVehiclesTx) Replace(values ...*models.Model) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a manufacturerHasManyVehiclesTx) Delete(values ...*models.Model) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IManufacturerDo interface {
	...
	Create(values ...*models.Manufacturer) error
	CreateInBatches(values []*models.Manufacturer, batchSize int) error
	Save(values ...*models.Manufacturer) error
	First() (*models.Manufacturer, error)
	Take() (*models.Manufacturer, error)
	Last() (*models.Manufacturer, error)
	Find() ([]*models.Manufacturer, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Manufacturer, err error)
	FindInBatches(result *[]*models.Manufacturer, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Manufacturer) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Manufacturer, error)
	FirstOrCreate() (*models.Manufacturer, error)
	FindByPage(offset int, limit int) (result []*models.Manufacturer, count int64, err error)
...
func (m manufacturerDo) Create(values ...*models.Manufacturer) error {
	if len(values) == 0 {
		return nil
	}
...
func (m manufacturerDo) CreateInBatches(values []*models.Manufacturer, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m manufacturerDo) Save(values ...*models.Manufacturer) error {
	if len(values) == 0 {
		return nil
	}
...
func (m manufacturerDo) First() (*models.Manufacturer, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Manufacturer), nil
	}
}

func (m manufacturerDo) Take() (*models.Manufacturer, error) {
...
func (m manufacturerDo) Last() (*models.Manufacturer, error) {
...
func (m manufacturerDo) Find() ([]*models.Manufacturer, error) {
	result, err := m.DO.Find()
	return result.([]*models.Manufacturer), err
}

func (m manufacturerDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Manufacturer, err error) {
	buf := make([]*models.Manufacturer, 0, batchSize)
...
func (m manufacturerDo) FindInBatches(result *[]*models.Manufacturer, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m manufacturerDo) FirstOrInit() (*models.Manufacturer, error) {
...
func (m manufacturerDo) FirstOrCreate() (*models.Manufacturer, error) {
...
func (m manufacturerDo) FindByPage(offset int, limit int) (result []*models.Manufacturer, count int64, err error) {
...
func (m manufacturerDo) Delete(models ...*models.Manufacturer) (result gen.ResultInfo, err error) {
