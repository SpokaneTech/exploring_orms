...
func newPart(db *gorm.DB, opts ...gen.DOOption) part {
	...
	_part.partDo.UseModel(&models.Part{})
	...
	_part.Cost = field.NewField(tableName, "cost")
	_part.Models = partManyToManyModels{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Models", "models.Model"),
		Manufacturer: struct {
			field.RelationField
			Vehicles struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Models.Manufacturer", "models.Manufacturer"),
			Vehicles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Models.Manufacturer.Vehicles", "models.Model"),
			},
		},
		Parts: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("Models.Parts", "models.Part"),
			Models: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Models.Parts.Models", "models.Model"),
			},
		},
	}
...
func (p *part) updateTableName(table string) *part {
	...
	p.Cost = field.NewField(table, "cost")
...
func (a partManyToManyModels) Model(m *models.Part) *partManyToManyModelsTx {
	return &partManyToManyModelsTx{a.db.Model(m).Association(a.Name())}
}

type partManyToManyModelsTx struct{ tx *gorm.Association }

func (a partManyToManyModelsTx) Find() (result []*models.Model, err error) {
	return result, a.tx.Find(&result)
}

func (a partManyToManyModelsTx) Append(values ...*models.Model) (err error) {
...
func (a partManyToManyModelsTx) Replace(values ...*models.Model) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a partManyToManyModelsTx) Delete(values ...*models.Model) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IPartDo interface {
	...
	Unscoped() IPartDo
	Create(values ...*models.Part) error
	CreateInBatches(values []*models.Part, batchSize int) error
	Save(values ...*models.Part) error
	First() (*models.Part, error)
	Take() (*models.Part, error)
	Last() (*models.Part, error)
	Find() ([]*models.Part, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Part, err error)
	FindInBatches(result *[]*models.Part, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Part) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Part, error)
	FirstOrCreate() (*models.Part, error)
	FindByPage(offset int, limit int) (result []*models.Part, count int64, err error)
...
func (p partDo) Create(values ...*models.Part) error {
	if len(values) == 0 {
		return nil
	}
...
func (p partDo) CreateInBatches(values []*models.Part, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p partDo) Save(values ...*models.Part) error {
	if len(values) == 0 {
		return nil
	}
...
func (p partDo) First() (*models.Part, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Part), nil
	}
}

func (p partDo) Take() (*models.Part, error) {
...
func (p partDo) Last() (*models.Part, error) {
...
func (p partDo) Find() ([]*models.Part, error) {
	result, err := p.DO.Find()
	return result.([]*models.Part), err
}

func (p partDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Part, err error) {
	buf := make([]*models.Part, 0, batchSize)
...
func (p partDo) FindInBatches(result *[]*models.Part, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p partDo) FirstOrInit() (*models.Part, error) {
...
func (p partDo) FirstOrCreate() (*models.Part, error) {
...
func (p partDo) FindByPage(offset int, limit int) (result []*models.Part, count int64, err error) {
...
func (p partDo) Delete(models ...*models.Part) (result gen.ResultInfo, err error) {
