...
func newModel(db *gorm.DB, opts ...gen.DOOption) model {
	...
	_model.DeletedAt = field.NewField(tableName, "deleted_at")
	_model.Name = field.NewString(tableName, "name")
	_model.ManufacturerID = field.NewUint(tableName, "manufacturer_id")
	_model.Manufacturer = modelBelongsToManufacturer{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Manufacturer", "models.Manufacturer"),
		Vehicles: struct {
			field.RelationField
			Manufacturer struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Manufacturer.Vehicles", "models.Model"),
			Manufacturer: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Manufacturer.Vehicles.Manufacturer", "models.Manufacturer"),
			},
			Parts: struct {
				field.RelationField
				Models struct {
				...
				RelationField: field.NewRelation("Manufacturer.Vehicles.Parts", "models.Part"),
				Models: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Manufacturer.Vehicles.Parts.Models", "models.Model"),
				},
			},
		},
	}

	_model.Parts = modelManyToManyParts{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Parts", "models.Part"),
	}
...
type model struct {
	...
	Manufacturer   modelBelongsToManufacturer

	Parts modelManyToManyParts
...
func (m *model) updateTableName(table string) *model {
	...
	m.ManufacturerID = field.NewUint(table, "manufacturer_id")
...
func (m *model) fillFieldMap() {
	...
	m.fieldMap["manufacturer_id"] = m.ManufacturerID
...
type modelBelongsToManufacturer struct {
	db *gorm.DB
...
func (a modelBelongsToManufacturer) Where(conds ...field.Expr) *modelBelongsToManufacturer {
	if len(conds) == 0 {
		return &a
	}
...
func (a modelBelongsToManufacturer) WithContext(ctx context.Context) *modelBelongsToManufacturer {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a modelBelongsToManufacturer) Session(session *gorm.Session) *modelBelongsToManufacturer {
	a.db = a.db.Session(session)
	return &a
}

func (a modelBelongsToManufacturer) Model(m *models.Model) *modelBelongsToManufacturerTx {
	return &modelBelongsToManufacturerTx{a.db.Model(m).Association(a.Name())}
}

type modelBelongsToManufacturerTx struct{ tx *gorm.Association }

func (a modelBelongsToManufacturerTx) Find() (result *models.Manufacturer, err error) {
	return result, a.tx.Find(&result)
}

func (a modelBelongsToManufacturerTx) Append(values ...*models.Manufacturer) (err error) {
...
func (a modelBelongsToManufacturerTx) Replace(values ...*models.Manufacturer) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a modelBelongsToManufacturerTx) Delete(values ...*models.Manufacturer) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a modelBelongsToManufacturerTx) Clear() error {
	return a.tx.Clear()
}

func (a modelBelongsToManufacturerTx) Count() int64 {
	return a.tx.Count()
}

type modelManyToManyParts struct {
	db *gorm.DB

	field.RelationField
}

func (a modelManyToManyParts) Where(conds ...field.Expr) *modelManyToManyParts {
	if len(conds) == 0 {
		return &a
	}
...
func (a modelManyToManyParts) WithContext(ctx context.Context) *modelManyToManyParts {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a modelManyToManyParts) Session(session *gorm.Session) *modelManyToManyParts {
	a.db = a.db.Session(session)
	return &a
}

func (a modelManyToManyParts) Model(m *models.Model) *modelManyToManyPartsTx {
	return &modelManyToManyPartsTx{a.db.Model(m).Association(a.Name())}
}

type modelManyToManyPartsTx struct{ tx *gorm.Association }

func (a modelManyToManyPartsTx) Find() (result []*models.Part, err error) {
	return result, a.tx.Find(&result)
}

func (a modelManyToManyPartsTx) Append(values ...*models.Part) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a modelManyToManyPartsTx) Replace(values ...*models.Part) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a modelManyToManyPartsTx) Delete(values ...*models.Part) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a modelManyToManyPartsTx) Clear() error {
	return a.tx.Clear()
}

func (a modelManyToManyPartsTx) Count() int64 {
	return a.tx.Count()
}
